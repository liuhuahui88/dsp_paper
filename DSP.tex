...
This optimization method is $p_i(x)$ free thus much easier to implement.
...
It's obvious that DD and dd are of the same form, thus DD = dd. As a result, we have P = D and strong duality holds.
